        ...
        children: <Widget>[
          new Row(
            children: <Widget>[
              new Padding(
                padding:
                    const EdgeInsets.only(left: 10.0, top: 0.0, right: 10.0),
...
class _DeformAniWidgetState extends State<DeformAniWidget>
  ...
  void _initAni() {
    height = Tween<double>(
      ...
      ..addListener(() {
        print("height animationTest addListener ------ *** ");
        setState(() {});
      })
      ..addStatusListener((AnimationStatus status) {
        print("height animationTest addListener ------ ***  $status");
      });
    ...
    width = Tween<double>(
      ...
      ..addListener(() {
        print("width animationTest addListener ------ *** ");
        setState(() {});
      })
      ..addStatusListener((AnimationStatus status) {
        print("width animationTest addListener ------ ***  $status");
      });
  }
