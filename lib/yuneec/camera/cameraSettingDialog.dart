...
//class CameraSettingDialog extends StatelessWidget {
...
class CameraSettingDialog extends StatefulWidget {
  CameraSettingDialog({Key key}) : super(key: key);

  @override
  _CameraSettingDialogState createState() {
    return _CameraSettingDialogState();
  }
...
class _CameraSettingDialogState extends State<CameraSettingDialog> {
  Map ThermalViewMode = {
    "type": 0,
